...
export const CurrWeather = memo(({}) => {
  ...
  return (
    <div className="w-full flex flex-row items-center justify-between max-w-[180rem] p-3">
      <div className="h-full flex flex-col">
        <div className="flex flex-row items-center justify-start gap-1">
          ...
          <span className="text-xl md:text-3xl font-bold">
            {currWeather?.country_code? ', ' + currWeather?.country_code  : ""}
          </span>
        </div>
      ...
      <div className="flex flex-col flex-grow justify-start items-center">
        <div className="flex items-center justify-center relative">
          ...
          <FA icon="circle-c" className="absolute top-4 -right-6 lg:-right-4" />
        </div>
